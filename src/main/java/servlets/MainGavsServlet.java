...
public class MainGavsServlet extends HttpServlet {
    private static final Logger LOGGER = LogManager.getLogger(MainGavsServlet.class);

    DBService dbService;

    public MainGavsServlet(DBService dbService) {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        Set<GavDataSet> gavDataSets = dbService.getMainGavs(groupId, artifactId, version);
